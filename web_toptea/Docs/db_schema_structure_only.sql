...
CREATE TABLE `kds_product_recipes` (
  ...
  `product_id` int UNSIGNED NOT NULL,
  `material_id` int UNSIGNED NOT NULL,
  `unit_id` int UNSIGNED NULL COMMENT '单位ID (FILL_LINE模式下可为NULL)',
  `quantity` decimal(10,2) NOT NULL COMMENT '数量',
  `measurement_type` enum('STANDARD','FILL_LINE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'STANDARD' COMMENT '计量方式: STANDARD=标准(数量+单位), FILL_LINE=至杯线(如至550线)',
