 ...
 * Revision: 9.9 (API Gateway Refactor)
 */
...
async function performPrepAction(buttonElement) {
    ...
    const API_URL_RECORD = 'api/kds_api_gateway.php?res=expiry&act=record';
    ...
    try {
        const response = await fetch(API_URL_RECORD, { 
            method: 'POST', 
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- [PHASE 4.4] MODIFICATION START ---
    const API_URL_GET = 'api/kds_api_gateway.php?res=prep&act=get_materials';
    // --- [PHASE 4.4] MODIFICATION END ---
